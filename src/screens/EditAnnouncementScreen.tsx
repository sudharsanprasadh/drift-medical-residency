...
import { updateAnnouncement } from '../services/announcementApi';
...
export default function EditAnnouncementScreen({ navigation, route }: any) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      await updateAnnouncement(announcement.id, title.trim(), content.trim());
  ...
  const handleCancel = () => {
    if (title !== announcement.title || content !== announcement.content) {
      Alert.alert(
        'Discard Changes?',
